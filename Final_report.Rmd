...
data_set2 <- subset(data, select = c(patient_file_no,
                                     weight_kg,
                                     height_cm,
                                     bmi,
                                     hip_inch,
...
data_set2 <- full_join(data_set1, data_set2, by = "patient_file_no")

# Create dataset 3 using variables obtained through patient history, clinical examination and blood tests
data_set3 <- subset(data, select = c(patient_file_no,
                                     fsh_m_iu_m_l,
                                     lh_m_iu_m_l,
                                     fsh_lh,
                                     amh_ng_m_l,
...
data_set3 <- full_join(data_set2, data_set3, by = "patient_file_no")
